...
enum class FrameType : int16_t {
    ...
    kMsgType_Ask_FileSamples,
    kMsgType_Answer_FileSamples,
    kMsgType_Ask_ArchivePack,
    kMsgType_Answer_ArchivePack,
    kMsgType_Ask_ArchiveReady,
    kMsgType_Answer_ArchiveReady,
